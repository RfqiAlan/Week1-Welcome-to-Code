...
console.log('First Word: ' + exampleFirstWord + ', Second Word: ' + secondWord + ', Third Word: ' + thirdWord + ', Fourth Word: ' + fourthWord + ', Fifth Word: ' + fifthWord);
...
console.log('First Word: ' + exampleFirstWord3 + ', Second Word: ' + secondWord3 + ', Third Word: ' + thirdWord3 + ', Fourth Word: ' + fourthWord3 + ', Fifth Word: ' + fifthWord3);
```
...
console.log('Second Word: ' + secondWord4 + ', Dengan panjang: ' + secondWordLength + " Huruf");
console.log('Third Word: ' + thirdWord4 + ', Dengan panjang: ' + thirdWordLength + " Huruf");
console.log('Fourth Word: ' + fourthWord4 + ', Dengan panjang: ' + fourthWordLength + " Huruf");
console.log('Fifth Word: ' + fifthWord4 + ', Dengan panjang: ' + fifthWordLength + " Huruf");
```
